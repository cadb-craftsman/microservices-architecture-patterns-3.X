...
public class ReactServiceRepositoryTest {
	...
	private static ReactServiceEntity bean;

	@BeforeAll
	static void initAll() {
		bean = new ReactServiceEntity(1L, "Object", "Object description");
	}
	...
	void testFindById() {
		Mono<ReactServiceEntity> b = repository.findById(bean.getId()); 
		if(b.block() != null) {
	...
	void testFindAll() {
		Flux<ReactServiceEntity> list = repository.findAll(); 
