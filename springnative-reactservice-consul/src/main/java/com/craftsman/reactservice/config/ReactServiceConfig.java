package com.craftsman.reactservice.config;
...
import com.craftsman.reactservice.domain.mappers.ReactServiceFactoryMapperImpl;
...
@Configuration
public class ReactServiceConfig {
	...
	public GroupedOpenApi customOpenAPI(@Value("${springdoc.api-docs.version}") String appVersion,
		...
		return GroupedOpenApi.builder().group(group)
				...
				.pathsToMatch(paths).packagesToScan(packagedToMatch).build();
	}
